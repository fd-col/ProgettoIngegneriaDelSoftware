...
class ControlloreListaPrenotazioni:
    ...
    def get_lista_prenotazioni_cliente(self, email_cliente):
        return self.model.get_lista_prenotazioni_cliente(email_cliente)

    def elimina_prenotazioni_cliente(self, email_cliente):
        self.model.elimina_prenotazioni_cliente(email_cliente)

    def elimina_prenotazione_singola(self, email_cliente, data_inizio):
        self.model.elimina_prenotazione_singola(email_cliente, data_inizio)
