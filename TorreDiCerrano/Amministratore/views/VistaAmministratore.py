...
class VistaAmministratore(QWidget):
    ...
    def __init__(self, nome, parent=None):
        ...
        self.bottone_prenotazioni = self.create_button(" Lista Prenotazioni", self.go_lista_prenotazioni, "background-color:#FFD800;", 'Alt+P',
                           "images\\icon_prenotazione.png", )
        self.bottone_dipendenti = self.create_button(" Lista Dipendenti", self.go_lista_dipendenti, "background-color:#FFD800;", 'Alt+D',
                           "images\\icon_dipendenti.png", )
        self.bottone_resoconti = self.create_button("Resoconti", self.funzione_al_posto_di_resoconti, "background-color:#FFD800;", 'Alt+R',
